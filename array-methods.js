...
full_Name = runners.forEach(function(item){
  return console.log(`item.first_name + "last_name"`);
});
...
// The event director needs to have all the runner's first names converted to uppercase because the director BECAME DRUNK WITH POWER. Convert each first name into all caps and log the result
 let allCaps = [];
// console.log(allCaps); 
// const ourFirst_names = runners.map(item => item.first_name.toUpperCase())
// console.log(ourFirst_names);
...
//   console.log(`i am accumulator ${accumulator}`)
//   console.log(`i am currentvalue ${currentvalue.donation}`)
